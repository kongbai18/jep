...
class Permission extends Base
{
    /**
     *
     * @SWG\Get(path="/platformMgmt/v1/permission",
     *   summary="获取权限列表信息",
    ...
    /**
     *
     * @SWG\Get(path="/platformMgmt/v1/permission/{id}",
     *   summary="获取权限信息",
    ...
    /**
     *
     * @SWG\Post(path="/platformMgmt/v1/permission/getChild",
     *   summary="获取权限子集及本身",
     *   description="请求该接口需要先登录并且有此权限。",
    ...
    /**
     *
     * @SWG\Post(path="/platformMgmt/v1/permission",
     *   summary="添加权限",
     *   description="请求该接口需要先登录并且有此权限。",
    ...
    /**
     *
     * @SWG\Get(path="/platformMgmt/v1/permission/{id}/edit",
     *   summary="修改权限信息",
     *   description="请求该接口需要先登录并且有此权限。",
    ...
    /**
     *
     * @SWG\Delete(path="/platformMgmt/v1/permission/{id}",
     *   summary="删除权限",
     *   description="请求该接口需要先登录并且有此权限。",
     *   @SWG\Parameter(name="id",in="path",type="number",required="true",
     *      description="权限ID"
